...
if __name__ == "__main__":
    ...
    parser.add_argument("-t_file", type=str, required=False, help="Path to text file")
    ...
    text = args.text
    if args.t_file:
        with open(args.t_file, "r", encoding="utf-8") as f:
            text = f.read().strip()
    if not text:
        raise ValueError("No text provided via -t or -t_file")
